...
def update_payment_data_table(results):
    ...
    avg_active_students = results.get('avg_active_students', 0)
    active_students_pct = results.get('active_students_pct', 0)
    annual_malengo_revenue = results.get('annual_malengo_revenue', 0)
    
    return html.Div([
        html.H4(f"{results['program_type']} Program - Payment & Student Data", style={'textAlign': 'center', 'marginBottom': '20px'}),
        html.Div([
        ...
        html.P("Malengo fees consist of a $300 annual fee per active student (adjusted for inflation) plus 2.5% of all repayments.",
              style={'marginBottom': '15px', 'fontStyle': 'italic', 'fontSize': '0.9em', 'textAlign': 'center'}),
        table
    ])
