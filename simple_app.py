...
def run_monte_carlo_simulation(n_clicks, num_sims, complexity, 
    ...
    for params in param_grid:
        ...
        results.append({
            ...
            'investor_irr': sim_result['nominal_investor_IRR'] * 100,
            'total_irr': sim_result['nominal_IRR'] * 100,
            ...
            'average_payment': sim_result['average_nominal_total_payment'],
    ...
    param_summary = html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.Table([
                    html.Tr([
                        html.Td("Preset Scenario:"), 
                        html.Td(preset_scenarios[preset_scenario]['name'] if preset_scenario in preset_scenarios else 'Default')
                    ]),
    ...
    irr_fig.update_layout(
        title='Distribution of Nominal Investor IRR',
    ...
    irr_stats = html.Div([
        html.H4("Nominal Return Metrics", className="mt-4"),
        html.Table([
            html.Thead(html.Tr([
                html.Th("Metric"),
                html.Th("Value")
